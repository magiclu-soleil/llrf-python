...
#        self.button_phase.hide()
    ...
    ######################################
        ...
        '''
        ###
        pen = pg.mkPen(color='k', width=line_w, style=QtCore.Qt.DashLine)
        # self.curve_q3 = self.plt_data.plot(self.fft_q[3], pen='y')
        # self.curve_i3 = self.plt_data.plot(self.fft_i[3], pen=pen)
        self.curve_q4 = self.plt_data.plot(self.buf_q[4], pen='k')
        self.curve_i4 = self.plt_data.plot(self.buf_i[4], pen=pen)
    ...
    def update_graph(self):
        ...
        '''
        ##################
        self.curve_q4.setData(self.buf_q[4])
        self.curve_i4.setData(self.buf_i[4])
        self.curve_q4.setPos(len(self.buf_q[4]), 0)
        self.curve_i4.setPos(len(self.buf_i[4]), 0)
        n = min(len(self.buf_q[4]), len(self.buf_i[4]))
    ...
    def clear_plot(self):
        try:
            self.curve_q.clear()
            self.curve_i.clear()
            self.ch0_scatter.clear()
            self.ch4_scatter.clear()
        ...
        try:
            self.curve_q1.clear()
            self.curve_i1.clear()
            self.ch1_scatter.clear()
        except AttributeError:
            pass
        try:
            self.curve_q2.clear()
            self.curve_i2.clear()
            self.ch2_scatter.clear()
        except AttributeError:
            pass
        try:
            self.curve_q3.clear()
            self.curve_i3.clear()
            self.ch3_scatter.clear()
        except AttributeError:
            pass
