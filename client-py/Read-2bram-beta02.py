...
from circle import EllipseObject
...
class llrf_graph_window(QtWidgets.QMainWindow):
    ...
    def load_config(self):
        ...
        try:
            ...
            self.last_phase = self.ui_ph0_deg.text() + self.ui_ph1_deg.text() + self.ui_ph2_deg.text() +self.ui_ph3_deg.text()
        except IndexError:
            new_wb = copy(wb)
    ...
    def set_phase(self):
        ...
        addr = self.ui_ph0_add.text() + ',' + self.ui_ph1_add.text() + ',' + self.ui_ph2_add.text() + ',' + self.ui_ph3_add.text()
        deg = self.ui_ph0_deg.text() + ',' + self.ui_ph1_deg.text() + ',' + self.ui_ph2_deg.text() + ',' + self.ui_ph3_deg.text()
        #print(addr)
        #print(deg)
        msg = addr + ',' + deg
    ...
    def set_plot_ui(self):
        ...
        self.plt_ch0.setXRange(-20000, 20000, padding=0)
        self.plt_ch0.setYRange(-20000, 20000, padding=0)

        self.plt_ch1= self.plt_ch1_iq.addPlot()
        self.plt_ch1.setXRange(-20000, 20000, padding=0)
        self.plt_ch1.setYRange(-20000, 20000, padding=0)

        self.plt_ch2= self.plt_ch2_iq.addPlot()
        self.plt_ch2.setXRange(-20000, 20000, padding=0)
        self.plt_ch2.setYRange(-20000, 20000, padding=0)

        self.plt_ch3= self.plt_ch3_iq.addPlot()
        self.plt_ch3.setXRange(-20000, 20000, padding=0)
        self.plt_ch3.setYRange(-20000, 20000, padding=0)
    ...
    #################################
        ...
        self.ch0_scatter = self.plt_ch0.ScatterPlotItem(self.buf_i[0][0:n], self.buf_q[0][0:n], pen=None, symbol='o')
    ...
    ######################
        ...
        self.ch1_scatter = self.plt_ch1.plot(self.buf_i[1][0:n], self.buf_q[1][0:n], pen=None, symbol='o')
    ...
    #######################
        ...
        self.ch2_scatter = self.plt_ch2.plot(self.buf_i[2][0:n], self.buf_q[2][0:n], pen=None, symbol='o')
    ...
    ######################################
        ...
        self.ch3_scatter = self.plt_ch3.plot(self.buf_i[3][0:n], self.buf_q[3][0:n], pen=None, symbol='o')
        self.polar_plot(self.plt_ch3)

    def check_val(self):
        if self.last_phase != (self.ui_ph0_deg.text() + self.ui_ph1_deg.text() + self.ui_ph2_deg.text() + self.ui_ph3_deg.text()):
            print('last')
            print(self.last_phase)
            print('new')
            print(self.ui_ph0_deg.text() + self.ui_ph1_deg.text() + self.ui_ph2_deg.text() + self.ui_ph3_deg.text())
            if (not self.ui_ph0_deg.text()) | (not self.ui_ph1_deg.text()) | (not self.ui_ph2_deg.text()) | (not self.ui_ph3_deg.text()) == False:
                self.set_phase()
                self.last_phase = self.ui_ph0_deg.text() + self.ui_ph1_deg.text() + self.ui_ph2_deg.text() + self.ui_ph3_deg.text()
